...
@section('content')
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Edit The Manufacture</h3>
        </div>
        ...
        <form action="" method="post">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input name="name" required="" value="{{$manufacturer->name}}" type="text" class="form-control"  placeholder="Enter manufacture name">
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <input name="description" value="{{$manufacturer->description}}" type="text" class="form-control"  placeholder="Enter description">
                </div>
                <div class="form-group">
                    <label for="file">Image Manufacturer</label>
                    <input accept="image/*" type="file"  name="file" class="form-control-file" id="upload">
                    <div style="margin-top: 10px" class="row">
                        <div class="col-md-1 col-4">
                            <div name="image_show" id="image_show">
                                <a href="{{$manufacturer->logo}}" target="_blank"><img style="width: 100%"  src="{{$manufacturer->logo}}"></a>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" value="{{$manufacturer->logo}}" name="file_sc" id="file">
                </div>
                <div class="form-group">
                    <label>Active</label>
                    <div class="row">
